...
public class BleLinkManager {
    ...
    private class BleListViewAdapter extends ArrayAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            TextView buttonStateText = convertView.findViewById(R.id.btnState);
            ...
            convertView.findViewById(R.id.bleDeviceListMainLayout).setBackground(res.getDrawable(currentDevice.Checked ?
            ...
            Drawable ledStateBackground = convertView.findViewById(R.id.ledState).getBackground();
            ...
            TextView phyStateText = convertView.findViewById(R.id.phyState);
            phyStateText.setText(phyList[currentDevice.getPhy()]);

            TextView rssiStateText = convertView.findViewById(R.id.rssiState);
            rssiStateText.setText(currentDevice.getRssi() + " dBm");
            return convertView;
        }
    }
}
